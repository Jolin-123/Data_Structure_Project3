...
///////////////////////// TO-DO (3) //////////////////////////////
= default;       // the attributes all have the right behavior.
...
///////////////////////// TO-DO (7) //////////////////////////////
= default;
            // strings and double know how to destroy themselves.
/////////////////////// END-TO-DO (7) ////////////////////////////
...
{
  ///////////////////////// TO-DO (8) //////////////////////////////
    return _isbn;     // single & at the end, return references to the attributed of class.
  /////////////////////// END-TO-DO (8) ////////////////////////////
}
...
std::istream & operator>>( std::istream & stream, Book & book )
{
  ///////////////////////// TO-DO (21) //////////////////////////////
    ...
    if ( stream >>std::ws >> std::quoted(correctItem._isbn )  &&  stream >>std::ws >> punctuate  &&  punctuate == ','  &&
        stream >>std::ws >> std::quoted(correctItem._title )  &&  stream >>std::ws >> punctuate  &&  punctuate == ','  &&
        stream >>std::ws >> std::quoted(correctItem._author )  &&  stream >>std::ws >> punctuate  &&  punctuate == ','  &&
        stream >>std::ws >> correctItem._price )
    {
        book = std::move( correctItem );
    }
...
std::ostream & operator<<( std::ostream & stream, const Book & book )
{
  ///////////////////////// TO-DO (22) //////////////////////////////
    ...
    const std::string punctuate =", ";
    
    stream << std::quoted( book.isbn() ) << punctuate
           << std::quoted( book.title() ) << punctuate
           << std::quoted( book.author() ) << punctuate
    << book.price();
